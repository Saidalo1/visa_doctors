from app.serializers.pages import (AboutPreviewSerializer, AboutDetailSerializer, VisaTypeListSerializer, \
                                   VisaTypeDetailSerializer, ResultCategoryPreviewSerializer,
